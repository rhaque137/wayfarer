...
export function UpcomingTrips({
  ...
  return (
    <section id="upcoming" className="mx-auto w-full max-w-6xl px-6 py-16">
      ...
      <Reveal delay={120}>
        {trips.length === 0 ? (
          <div className="mt-8 rounded-2xl border border-neutral-100 bg-white p-8 text-center shadow-sm">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {trips.map((trip) => (
              <Link
                ...
                className="group relative overflow-hidden rounded-2xl border border-neutral-100 bg-white p-4 shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
              >
                <div
                  className={cn(
